...
enum CLOSED_ENUM InstantYieldType
{
	...
	INSTANT_YIELD_TYPE_CITY_CREATE_UNIT			= 62,
	INSTANT_YIELD_TYPE_NOBEL_PRIZE_PHYSICS		= 63,
	INSTANT_YIELD_TYPE_NOBEL_PRIZE_CHEMICAL		= 64,
	INSTANT_YIELD_TYPE_NOBEL_PRIZE_MEDICINE		= 65,
