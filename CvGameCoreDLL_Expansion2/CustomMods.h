...
#define MOD_SP_BALANCE_CORE        					gCustomMods.isSP_BALANCE_CORE()
#define MOD_API_BUILDINGS_YIELD_FROM_OTHER_YIELD    gCustomMods.isAPI_BUILDINGS_YIELD_FROM_OTHER_YIELD()
...
public:
	...
	MOD_OPT_DECL(SP_BALANCE_CORE);
	MOD_OPT_DECL(API_BUILDINGS_YIELD_FROM_OTHER_YIELD);
