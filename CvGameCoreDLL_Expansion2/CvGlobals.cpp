...
CvGlobals::CvGlobals() :
	...
	GD_INT_INIT(CORRUPTION_SCORE_PER_DISTANCE, 100),
	GD_INT_INIT(CORRUPTION_SCORE_COASTAL_BONUS, -200),
#endif
#if defined(MOD_TROOPS_AND_CROPS_FOR_SP)
	GD_INT_INIT(TROOP_RATE_TIMES100_LOW, 50),
	GD_INT_INIT(TROOP_RATE_TIMES100_DEFAULT, 100),
	GD_INT_INIT(TROOP_RATE_TIMES100_HIGH, 150),
	GD_INT_INIT(TROOP_NUM_BASE, 24),
#endif
#if defined(MOD_INTERNATIONAL_IMMIGRATION_FOR_SP)
	GD_INT_INIT(IMMIGRATION_BASE_RATE, 30),
#endif
#ifdef MOD_GLOBAL_WAR_CASUALTIES
	GD_INT_INIT(WAR_CASUALTIES_THRESHOLD, 200),
	GD_INT_INIT(WAR_CASUALTIES_DELTA_BASE, 100),
	GD_INT_INIT(WAR_CASUALTIES_POPULATION_LOSS, 1),
#endif
	GD_INT_INIT(PLOT_BUILD_MAX_WORKER, 1),
	GD_INT_INIT(HIGHT_MOD_MAX_ADVANTAGE, 2),
	GD_INT_INIT(MIN_PRODUCTION_NEEDED_MODIFIER_UNIT, -20),
	GD_INT_INIT(MIN_PRODUCTION_NEEDED_MODIFIER_BUILDING, -20),
	GD_INT_INIT(MIN_PRODUCTION_NEEDED_MODIFIER_PROJECT, -20),
...
void CvGlobals::cacheGlobals()
{
...
#endif
#if defined(MOD_TROOPS_AND_CROPS_FOR_SP)
	GD_INT_CACHE(TROOP_RATE_TIMES100_LOW);
	GD_INT_CACHE(TROOP_RATE_TIMES100_DEFAULT);
	GD_INT_CACHE(TROOP_RATE_TIMES100_HIGH);
	GD_INT_CACHE(TROOP_NUM_BASE);
#endif
#if defined(MOD_INTERNATIONAL_IMMIGRATION_FOR_SP)
	...
	GD_INT_CACHE(MIN_PRODUCTION_NEEDED_MODIFIER_UNIT);
	GD_INT_CACHE(MIN_PRODUCTION_NEEDED_MODIFIER_BUILDING);
	GD_INT_CACHE(MIN_PRODUCTION_NEEDED_MODIFIER_PROJECT);
	////////////// END DEFINES //////////////////
}
