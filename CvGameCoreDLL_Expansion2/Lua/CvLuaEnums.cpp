...
int CvLuaEnums::pRegister(lua_State* L)
{
	...
	RegisterEnum(INSTANT_YIELD_TYPE_CITY_CREATE_UNIT);
	RegisterEnum(INSTANT_YIELD_TYPE_NOBEL_PRIZE_PHYSICS);
	RegisterEnum(INSTANT_YIELD_TYPE_NOBEL_PRIZE_CHEMICAL);
	RegisterEnum(INSTANT_YIELD_TYPE_NOBEL_PRIZE_MEDICINE);
