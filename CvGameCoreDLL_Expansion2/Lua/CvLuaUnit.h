...
protected:
	...
	static int lGetMoveUsedAttackMod(lua_State* L);
	...
	LUAAPIEXTN(GetDoFallBackAttackMod, int);
	LUAAPIEXTN(GetBeFallBackDefenseMod, int);
	LUAAPIEXTN(GetNumDoFallBackThisTurn, int);
	LUAAPIEXTN(GetNumBeFallBackThisTurn, int);
	LUAAPIEXTN(GetNumOriginalCapitalAttackMod, int);
	LUAAPIEXTN(GetNumOriginalCapitalDefenseMod, int);
	LUAAPIEXTN(GetOnCapitalLandAttackMod, int);
	LUAAPIEXTN(GetOutsideCapitalLandAttackMod, int);
	LUAAPIEXTN(GetOnCapitalLandDefenseMod, int);
	LUAAPIEXTN(GetOutsideCapitalLandDefenseMod, int);
	LUAAPIEXTN(GetLostHitPointAttackMod, int);
