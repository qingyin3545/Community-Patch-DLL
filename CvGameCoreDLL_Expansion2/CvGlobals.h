...
public:
	...
	GD_INT_MEMBER(IMMIGRATION_BASE_RATE);
#endif
#if defined(MOD_GLOBAL_WAR_CASUALTIES)
	GD_INT_MEMBER(WAR_CASUALTIES_THRESHOLD);
	GD_INT_MEMBER(WAR_CASUALTIES_DELTA_BASE);
	GD_INT_MEMBER(WAR_CASUALTIES_POPULATION_LOSS);
#endif
	GD_INT_MEMBER(PLOT_BUILD_MAX_WORKER);
	GD_INT_MEMBER(HIGHT_MOD_MAX_ADVANTAGE);
	GD_INT_MEMBER(MIN_PRODUCTION_NEEDED_MODIFIER_UNIT);
	GD_INT_MEMBER(MIN_PRODUCTION_NEEDED_MODIFIER_BUILDING);
	GD_INT_MEMBER(MIN_PRODUCTION_NEEDED_MODIFIER_PROJECT);
