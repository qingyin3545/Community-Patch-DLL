...
alter table Beliefs add FreePromotionForProphet text references UnitPromotions(Type); -- Use Belief_FreePromotions
...
alter table Beliefs add FounderFreePromotion text references UnitPromotions(Type); -- Use Belief_FreePromotions
alter table Beliefs add FollowingCityFreePromotion text references UnitPromotions(Type); -- Use Belief_FreePromotions
create table Belief_LakePlotYieldChanges ( -- Use Belief_LakePlotYield
    BeliefType text references Beliefs(Type),
    YieldType text references Yields(Type),
    Yield integer default 0
);